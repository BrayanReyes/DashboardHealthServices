...
df_places['Count_Placeholder'] = df_places['cartodb_id']*2
...
Map_Fig=px.choropleth_mapbox(df_places,               #Data
            ...
            color='Count_Placeholder',                #Column giving the color intensity of the region
...
Map_Fig.update_layout(title='Health in Colmbia',paper_bgcolor="#F8F9F9")
